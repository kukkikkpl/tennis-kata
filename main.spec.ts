...
describe('Player 1', () => {
  it('should win the game when the score is 4-0', () => {
    ...
    // then
    expect(winner).to.equal('Player 1');
  });
...
describe('Player 2', () => {
  it('should win the game when the score is 4-0', () => {
    ...
    // then
    expect(winner).to.equal('Player 2');
  });
...
describe('Game', () => {
  it('should print thirty - thirty when the score is 2-2', () => {
    ...
    // then
    expect(score).to.equal('thirty - thirty');
  });
  ...
  it('should print advantage player 1 when the score is 4-3', () => {
    ...
    // then
    expect(score).to.equal('advantage player 1');
  });
  ...
  it('should print advantage player 2 when the score is 5-6', () => {
    ...
    // then
    expect(score).to.equal('advantage player 2');
  });
});